...
<div id="content" style="margin-top:2%; margin-bottom: 2%">
	<div class="row">
		<div class="col-lg-7 rounded font-weight-bold text-justify" style="background-color: #54A114; color:white;">
			<article>
				<p style="margin-top:7%;">El Hospital de Pelotillehue, con ustedes desde el año 1990 brindando atencion de primera calidad y a muy buen precio amplía su alcance saltando a las nuevas tecnologías, nos modernizamos construyendo un hermoso y funcional sitio para todos nuestros clientes.</p>
				<p>Rapidez y una atención de calidad son nuestro sello profesional, tenemos los mejores profesionales esperando a atenderte.</p>
				<p>Nos ubicamos entre Buenas Peras y Cumpeo</p>
				<p>¡Atiendete con nosotros hoy! </p>
			</article>
		</div>
		<div class="col-lg-5" style="background-color: #525451;">
	...
	<div class="row rounded" style="background-color: #938A03;  margin-top: 2%; margin-bottom: 2%;">
		...
		<div class="col-lg-5 offset-lg-1">
			<p><h2 class="font-italic" style="color:white;">"woof woof woof wof"</h2></p>
		</div>
	</div>
</div>
<?php
